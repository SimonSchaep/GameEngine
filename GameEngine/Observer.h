...
namespace engine
{
	...
	class Observer : public virtual ObservableObject //is observable object, because event needs to have observingpointers to observers, to make sure they are not dangling.
